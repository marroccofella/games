...
| **FREEL\*ADER 42: PROPERTY OVERFLOW** | [`freeloader-42/`](freeloader-42/) | Forty-two condemned digital properties, 126 evidence receipts, automatic 01–42 progression, visible goals, optional bonus audits, precision platforming, 2D/3D views, animated asterisk portals with original sound, and deadpan British failure. Latest: [2026.09.10-portal](freeloader-42/docs/portal-release.md). |
